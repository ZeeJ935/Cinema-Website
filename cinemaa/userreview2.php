...
<body>
  ...
  <div class="movie">
    <div class="icon">
      ...
      <div class="home">
        <a style="text-decoration: none;" , href="cinema.php">
    ...
    <h4 style="color:white">Release Date: <?php echo $ReleaseDate; ?></h4>
      ...
      <br>
      <h2 style="color:white;">To Rate and give comments about the movie, Kindly log IN or Sign up if you don't have an account</h2>
  ...
  font-weight: 600;
  width: 100px;
  margin-top: 10 px;">Log In</button></a>
    </form>
  </div>
